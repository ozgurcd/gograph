	...
	addTool(capabilitiesTool, func(_ context.Context, _ mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		resp := map[string]any{
			...
			"tools": []map[string]string{
				...
				{"name": "gograph_stats", "purpose": "Trusted persisted-index statistics, or startup-fallback statistics when no usable artifact exists: complete/partial build and precision status, file/reuse/rebuilt-package counts, failures, and graph totals."},
